...
**步驟：**
1. 把 `data.json` 檔案上傳給 AI
2. 用中文說明要新增或刪除什麼，例如：
   - 「請幫我新增過敏藥物：XXX，備註：XXX」
   - 「請幫我移除：XXX」
   - 「我有新的過敏紀錄如下，請整理進去：...」
3. AI 回傳修改好的 `data.json`
4. 下載後覆蓋 `allergy-checker` 資料夾裡的舊 `data.json`
5. 上傳到 GitHub（同步驟 3 的上傳方式）
...
1. 對方登入 GitHub，前往你的 repo 頁面
2. 點右上角 **Fork** 按鈕
3. 對方就有一份自己的獨立版本
4. 到 Settings → Pages 開啟部署，就有自己的網址
